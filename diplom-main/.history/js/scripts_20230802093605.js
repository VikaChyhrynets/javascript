...
// VIKA'S TASKS:
// Tabs. Works for both index.html and menu.html: 
$(document).ready(function() {
  ...
  const countDate = countdown.parentElement.getAttribute('data-countDate');

  // Function to update the countdown timer
  function updateCountdown() {
    const now = new Date().getTime();
    const targetDate = new Date(countDate).getTime();
    ...
    countdown.querySelector('.days').innerText = days < 10 ? '0' + days : days;
    countdown.querySelector('.hours').innerText = hours < 10 ? '0' + hours : hours;
    countdown.querySelector('.minutes').innerText = minutes < 10 ? '0' + minutes : minutes;
    countdown.querySelector('.seconds').innerText = seconds < 10 ? '0' + seconds : seconds;
  }
