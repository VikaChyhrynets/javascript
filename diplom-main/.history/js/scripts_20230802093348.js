...
$(document).ready(function() {
  ...
  function setClock(selector, endTime) {
    ...
    const days = document.querySelector('.days rot');
    const hours = document.querySelector('.hours rot');
    const minutes = document.querySelector('.minutes rot');
    const seconds = document.querySelector('.seconds rot');
