...
if (inputValue > 0 && inputValue >= 1 && inputValue <= 9) {
    console.log(`Number ${inputValue} is one-digit positive`)
} else if (inputValue > 0 && inputValue >= 10 && inputValue <= 99) {
    console.log(`Number ${inputValue} is two-digit positive`)
} else if (inputValue > 0 && inputValue >= 100 && inputValue <= 999) {
    console.log(`Number ${inputValue} is three-digit positive`)
} else if (inputValue < 0 && inputValue >= 1 && inputValue <= 9) { 
    console.log(`Number ${inputValue} is one-digit negative`)
} else if (inputValue < 0 && inputValue >= 10 && inputValue <= 99) { 
    console.log(`Number ${inputValue} is two-digit negative`)
} else if (inputValue < 0 && inputValue >= 100 && inputValue <= 999) { 
    console.log(`Number ${inputValue} is three-digit negative`)
} else if (inputValue == 0) {
    console.log("Entered value is 0") 
}
